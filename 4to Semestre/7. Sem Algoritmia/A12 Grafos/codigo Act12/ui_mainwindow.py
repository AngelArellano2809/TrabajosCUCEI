...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1165, 697)
        self.actionAbrir = QAction(MainWindow)
        self.actionAbrir.setObjectName(u"actionAbrir")
        self.actionGuardar = QAction(MainWindow)
        self.actionGuardar.setObjectName(u"actionGuardar")
        self.fuerza_bruta_accion = QAction(MainWindow)
        self.fuerza_bruta_accion.setObjectName(u"fuerza_bruta_accion")
        self.mostrar_puntos_action = QAction(MainWindow)
        self.mostrar_puntos_action.setObjectName(u"mostrar_puntos_action")
        ...
        self.gridLayout.addWidget(self.ordenar_id_pushButton, 8, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.ingresar_final_pushButton, 6, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.ingresar_inicio_pushButton, 7, 0, 1, 2)

        self.ordenar_dis_pushButton = QPushButton(self.groupBox)
        self.ordenar_dis_pushButton.setObjectName(u"ordenar_dis_pushButton")

        self.gridLayout.addWidget(self.ordenar_dis_pushButton, 9, 0, 1, 2)

        self.ordena_vel_pushButton = QPushButton(self.groupBox)
        self.ordena_vel_pushButton.setObjectName(u"ordena_vel_pushButton")

        self.gridLayout.addWidget(self.ordena_vel_pushButton, 10, 0, 1, 2)
        ...
        self.graphicsView.setGeometry(QRect(9, 9, 771, 561))
        ...
        self.mostrar_grafo_pushButton.setGeometry(QRect(580, 580, 550, 23))
        self.generar_grafo_pushButton = QPushButton(self.tab_3)
        self.generar_grafo_pushButton.setObjectName(u"generar_grafo_pushButton")
        self.generar_grafo_pushButton.setGeometry(QRect(10, 580, 550, 23))
        self.gafo_plainTextEdit = QPlainTextEdit(self.tab_3)
        self.gafo_plainTextEdit.setObjectName(u"gafo_plainTextEdit")
        self.gafo_plainTextEdit.setGeometry(QRect(790, 10, 341, 561))
        ...
        self.menubar.setGeometry(QRect(0, 0, 1165, 21))
        ...
        self.menuPuntos.addAction(self.mostrar_puntos_action)
        self.menuPuntos.addAction(self.fuerza_bruta_accion)
    ...
    def retranslateUi(self, MainWindow):
...
#endif // QT_CONFIG(shortcut)
        self.fuerza_bruta_accion.setText(QCoreApplication.translate("MainWindow", u"Fuerza Bruta", None))
        self.mostrar_puntos_action.setText(QCoreApplication.translate("MainWindow", u"Mostrar puntos (x,y)", None))
        ...
        self.ordenar_dis_pushButton.setText(QCoreApplication.translate("MainWindow", u"Ordenar Distancia", None))
        self.ordena_vel_pushButton.setText(QCoreApplication.translate("MainWindow", u"Ordenar Velocidad", None))
        ...
        self.mostrar_grafo_pushButton.setText(QCoreApplication.translate("MainWindow", u"Mostra", None))
        self.generar_grafo_pushButton.setText(QCoreApplication.translate("MainWindow", u"Generar Grafo", None))
