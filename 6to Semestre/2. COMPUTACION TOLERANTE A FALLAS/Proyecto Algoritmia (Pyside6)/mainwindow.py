from PySide6.QtWidgets import QMainWindow, QGraphicsScene, QFileDialog, QMessageBox
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        #self.action_abrirArchivoAristas()
        self.action_abrirArchivoVertices()
    ...
    def agregar_asintota(self):
        ...
        self.ui.inicio_pinBox.clear()
        self.ui.final_spinBox.clear()
    ...
    def click_agregar(self):
        ...
        self.ui.origen_x_spinBox.clear()
        self.ui.origen_y_spinBox.clear()
